...
public class PaintBrushSetter {
    public static void DefaultPaintBrushSetting(PaintBrush paintBrush) {
        // add code
    }
    ...
    public static void LeavesPaintBrushSetting(PaintBrush paintBrush) {
        // add code
    }
...
class DefaultPaintBrushInfo {
    PaintBrushInfo[] arrDefaultPaintBrush;

    DefaultPaintBrushInfo() {
...
class CharcoalPaintBrushInfo {
    PaintBrushInfo[] arrCharcoalPaintBrush;

    CharcoalPaintBrushInfo() {
...
class ShortGrassPaintBrushInfo {
    PaintBrushInfo[] arrShortGrassPaintBrush;

    ShortGrassPaintBrushInfo() {
...
class WatercolorExpressivePaintBrushInfo {
    PaintBrushInfo[] arrWatercolorExpressivePaintBrush;

    WatercolorExpressivePaintBrushInfo() {
...
class LeavesPaintBrushInfo {
    PaintBrushInfo[] arrLeavesPaintBrush;

    LeavesPaintBrushInfo() {
...
class GlowPaintBrushInfo {
    PaintBrushInfo[] arrGlowPaintBrush;
